...
namespace VehicleAuction.Web.Migrations
{
    ...
    [Migration("20250525155120_AddBankInfoToCompany")]
    partial class AddBankInfoToCompany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VehicleAuction.Web.Models.Bid", b =>
                {
                    ...
                    b.HasOne("VehicleAuction.Web.Models.User", "Bidder")
                        .WithMany("Bids")
                        .HasForeignKey("BidderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VehicleAuction.Web.Models.Company", null)
                        .WithMany("Bids")
                        .HasForeignKey("CompanyId");
